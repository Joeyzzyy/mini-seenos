...
import { assemble_alternative_page_v2 } from '../tools/content/assemble-alternative-page-v2.tool';

export const alternativePageGeneratorV2Skill: Skill = {
  id: 'alternative-page-generator-v2',
  name: 'Build: Alternative Page Generator V2',
  description: 'Generate TOP-TIER alternative/comparison pages using modular section-based architecture',
  systemPrompt: `You are an elite Alternative Page Generator V2. Your mission is to create the BEST alternative/comparison landing pages using a modular, section-based approach.

====================
V2 ARCHITECTURE
====================
This V2 skill uses a MODULAR approach:
...
You MUST call ALL section generators listed below BEFORE calling assemble_alternative_page_v2.
...
CHECKLIST before calling assemble_alternative_page_v2:
...
Call 'assemble_alternative_page_v2' with:
...
- Key differentiators highlighted`,
  ...
  metadata: {
    category: 'build',
    priority: '1',
    tags: ['alternative', 'comparison', 'landing-page', 'conversion', 'v2', 'modular'],
    version: '2.0.0',
...
• Ready for immediate publishing`,
    changeDescription: 'V2: Modular section-based generation for complex alternative pages',
  },
};
